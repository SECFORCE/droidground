                ...
                <div className="modal-box">
                    ...
                    <form onSubmit={startActivityForm.handleSubmit(startActivity)}>
                        ...
                        <fieldset className="fieldset">
                            ...
                            <input type="text" placeholder="com.example.app/.MainActivity" className="input w-full" {...startActivityForm.register("activity", {required: true, minLength: 4})}/>
                        </fieldset>

                        <fieldset className="fieldset">
                            <legend className="fieldset-legend">Action</legend>
                            <input type="text" placeholder="Action" className="input w-full" {...startActivityForm.register("action")}/>
                            <p className="label">Optional</p>
                        </fieldset>

                        <fieldset className="fieldset">
                            <legend className="fieldset-legend">Data URI</legend>
                            <input type="text" placeholder="Data URI" className="input w-full" {...startActivityForm.register("dataUri")}/>
                            <p className="label">Optional</p>
                        </fieldset>

                        <fieldset className="fieldset">
                            <legend className="fieldset-legend">MIME Type</legend>
                            <input type="text" placeholder="MIME Type" className="input w-full" {...startActivityForm.register("mimeType")}/>
                            <p className="label">Optional</p>
                        </fieldset>
                ...
                <div className="modal-box">
                    ...
                    <form onSubmit={startBroadcastReceiverForm.handleSubmit(startBroadcastReceiver)}>
                        ...
                        <fieldset className="fieldset">
                            ...
                            <input type="text" placeholder="com.example.app/.MainActivity" className="input w-full" {...startBroadcastReceiverForm.register("receiver", {required: true, minLength: 4})}/>
                        </fieldset>

                        <fieldset className="fieldset">
                            <legend className="fieldset-legend">Action</legend>
                            <input type="text" placeholder="Action" className="input w-full" {...startBroadcastReceiverForm.register("action")}/>
                            <p className="label">Optional</p>
                        </fieldset>
                        <input className="btn btn-info" type="submit" value="Start" />
                    </form>
                ...
                <div className="modal-box">
                    ...
                    <form onSubmit={startServiceForm.handleSubmit(startService)}>
                        ...
                        <fieldset className="fieldset">
                            ...
                            <input type="text" placeholder="com.example.app/.MainActivity" className="input w-full" {...startServiceForm.register("service", {required: true, minLength: 4})}/>
                        </fieldset>

                        <fieldset className="fieldset">
                            <legend className="fieldset-legend">Action</legend>
                            <input type="text" placeholder="Action" className="input w-full" {...startServiceForm.register("action")}/>
                            <p className="label">Optional</p>
                        </fieldset>
                        <input className="btn btn-info" type="submit" value="Start" />
                    </form>
                    ...
                    <div className="collapse collapse-arrow bg-base-300 border border-base-300">
                        ...
                        <div className="collapse-content text-sm flex flex-col items-center justify-between gap-4">
                            <div className="flex w-full justify-between items-center">
                                <p>Start <b>Activity</b></p>
                                <div className="join">
                                    <button className="btn btn-info join-item rounded-r-md" onClick={() => startActivityDialogRef.current?.showModal()}>Start</button>
                                </div>
                            </div>

                            <div className="flex w-full justify-between items-center">
                                <p>Start <b>Broadcast Receiver</b></p>
                                <div className="join">
                                    <button className="btn btn-info join-item rounded-r-md" onClick={() => startBroadcastReceiverDialogRef.current?.showModal()}>Start</button>
                                </div>
                            </div>

                            <div className="flex w-full justify-between items-center">
                                <p>Start <b>Service</b></p>
                                <div className="join">
                                    <button className="btn btn-info join-item rounded-r-md" onClick={() => startServiceDialogRef.current?.showModal()}>Start</button>
                                </div>
                            </div>
                        </div>
                    </div>
